...
|--------|---------|-------------|
| [aidlc](https://github.com/bluejayA/aidlc-devflow) | 1.12.0 | AI-DLC methodology workflow plugin (orchestrator-centric, 28 skills + 3 utils, advisory mid-cycle sync, memory templates for best-practice delegation, 4-stage code review) |
